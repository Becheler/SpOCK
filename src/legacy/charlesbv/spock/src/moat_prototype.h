...
int print_progress_epoch_sc_to_epoch_constellation(
  double min_end_time,
  double et,
  double starttime,
  int iProc,
...
double distance_between_two_sc(
  double eci_r_sc1[3],
  double eci_r_sc2[3]
);
