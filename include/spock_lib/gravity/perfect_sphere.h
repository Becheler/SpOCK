...
namespace spock::gravity::model
{
  ...
  public:
    ...
    {
      constexpr units::isq::si::length<units::isq::si::metre, double> h = units::si::quantity_cast<units::isq::si::metre>(alt);
      constexpr units::isq::si::length<units::isq::si::metre, double> r = units::si::quantity_cast<units::isq::si::metre>(&planet_type::r);
