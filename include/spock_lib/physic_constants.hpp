...
namespace spock
{
  ...
  namespace physic_constants
  {
    ...
    struct earth
    {
      ...
      /// @brief Earth Mass
      ///
      static inline constexpr auto mass = units::quantity_cast<units::isq::si::gram>(5.9722 * std::pow(10,24) * kg);
      ///
      /// @brief Earth Radius
      ///
      static inline constexpr auto r = units::quantity_kind<radius, units::isq::si::metre, double>(6371000 * m);
    };
  }
}
